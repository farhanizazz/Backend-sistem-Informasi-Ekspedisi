...
namespace App\Http\Resources\LainLain;

use Illuminate\Http\Resources\Json\JsonResource;

class LainLainResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'nominal_lain' => $this->nominal_lain,
            'jumlah_lain' => $this->jumlah_lain,
            'total_lain' => $this->total_lain,
            'nama_tujuan_lain' => $this->nama_tujuan_lain,
        ];
    }
}
